...
<div class="row">
   	<div class="col-md-12">
        ...
        <div class="panel panel-default">
            <form class="blogpost form-horizontal" role="form" method="POST">
            {{ csrf_field() }}
                <div class="form-group">
                    <label for="title" class=" col-md-2 control-label">Title:</label>
                    <input type="text" name="title" class="col-md-4" value="<?php echo (isset($blog))? $blog->title: '';?>">
                </div>
                <div class="form-group">
                    <label for="small_desc" class="col-md-2 control-label">Small description:</label>
                    <input type="text" name="small_desc" class="col-md-8" value="<?php echo (isset($blog))? $blog->small_desc: '';?>">
                </div>
                <div class="form-group">
                    <label for="body" class="col-md-2 control-label">Blog body:</label>
                    <textarea type="text" name="body" class="col-md-9" rows="18"><?php echo (isset($blog))? $blog->body: '';?></textarea>
                </div>
                <div class="form-group">
